...
FAQ = [
    ...
    ("Kakva podrška je dostupna?", "Podrška je dostupna radnim danima od 9 do 15 časova: telefonom, emailom, putem Viber-a ili WhatsApp-a. Rad na daljinu dogovaramo prema potrebi."),
]
...
<section class="hero" id="pocetna"><div class="container hero-grid">
  ...
  <figure class="hero-product"><div class="product-label"><span class="status-dot"></span> Budžet+ <span>Pregled poslovanja</span></div><a class="zoom-image" href="assets/img/kon-tabla.png"><img src="assets/img/kon-tabla.png" alt="Kontrolna tabla Budžet+ sa pregledom poslovanja škole" width="1920" height="1032" fetchpriority="high"></a><figcaption><span>Plan. Realizacija. Jasan pregled.</span><span aria-hidden="true">↗</span></figcaption><div class="product-footnote"><span class="check-mark" aria-hidden="true">✓</span> Podaci ostaju kod vas.<br><small>Stručna kontrola ostaje u vašim rukama.</small></div></figure>
</div></section>
