...
PAGES = [
    ...
    },
    {
        ...
        "sections": [
            ("Šta znači kumulativno plaćanje?", "Umesto ručnog unosa podataka na SPIRI portalu, više izabranih e-faktura objedinjeno je u jedan fajl za kumulativno plaćanje. Time se skraćuje administrativni deo posla, dok računovođa zadržava završnu proveru."),
    ...
    },
    {
        ...
        "description": "Budžet+ priprema Obrazac 5 iz proknjiženih podataka, a korisnik preuzima fajl spreman za učitavanje u ISPFI.",
        "kicker": "Iz proknjiženih podataka",
        "h1": "Obrazac 5 spreman za ISPFI bez ponovnog kucanja",
        "intro": "Budžet+ koristi već kontrolisane i proknjižene podatke da pripremi Obrazac 5. Korisnik preuzima fajl koji je spreman za učitavanje u ISPFI.",
        "summary_title": "Manje koraka do izveštaja",
        "summary": ["Nema ponovnog unosa istih podataka", "Brza priprema Obrasca 5", "Preuzimanje gotovog fajla", "Fajl spreman za ISPFI"],
        "sections": [
            ...
            ("Pregled pre preuzimanja", "Računovođa može da pregleda podatke pre preuzimanja fajla. Automatizacija ubrzava pripremu, ali odluka o konačnoj tačnosti ostaje kod korisnika."),
            ("Fajl za ISPFI", "Nakon provere korisnik preuzima Obrazac 5 u fajlu koji je spreman za učitavanje u ISPFI. Nema dodatnih međukoraka ni ponovnog kucanja."),
            ("Izveštaj bez događaja u kalendaru", "Obrazac 5 više ne mora da bude višesatni poseban posao pred rok. Kada su knjiženja ažurna, priprema se svodi na pregled i preuzimanje fajla."),
        ],
        "process_title": "Kako nastaje Obrazac 5",
        "process": ["Budžet+ koristi podatke iz završenih knjiženja.", "Program formira Obrazac 5 iz postojećih podataka.", "Računovođa pregleda rezultat.", "Korisnik preuzima fajl spreman za učitavanje u ISPFI."],
    ...
    },
    {
        ...
        "description": "Budžet+ omogućava brzu evidenciju uplata učenika i preglede po učeniku, aktivnosti i blagajničkom radu.",
        "kicker": "Evidencija za blagajnika",
        "h1": "Uplate učenika pregledne po učeniku i aktivnosti",
        "intro": "Budžet+ omogućava brz unos uplata učenika i jasan pregled po učeniku, aktivnosti i blagajničkom radu.",
        "summary_title": "Pregled koji prati stvarni rad",
        "summary": ["Evidencija po učeniku", "Pregled po aktivnosti", "Brz rad blagajnika", "Zbirni pregledi uplata"],
        "sections": [
            ...
            ("Pregled za svakodnevni rad", "Škola dobija jasnu evidenciju uplata po učeniku i aktivnosti, uz zbirne preglede koji olakšavaju blagajničku kontrolu."),
        ],
