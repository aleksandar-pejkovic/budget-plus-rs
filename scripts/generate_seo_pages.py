...
PAGES = [
    {
        ...
        "summary": ["Budžetsko knjigovodstvo i kontni plan", "SEF/eFakture, XML fakture i SPIRI izvodi", "SPIRI XML, ORIS JSON i Obrazac 5", "Osnovna sredstva, izveštaji i pomoćne evidencije"],
        "sections": [
    ...
    },
    {
        ...
        "description": "Budžet+ za škole povlači podatke sa e-faktura i kreira SPIRI fajl za kumulativno plaćanje: više faktura, jedan fajl.",
        "kicker": "Više faktura, jedan fajl",
        "h1": "SPIRI kumulativno plaćanje iz e-faktura",
        "intro": "Budžet+ povuče podatke sa e-faktura, objedini obaveze i kreira fajl za SPIRI. Računovođa pregleda rezultat.",
        "summary_title": "Tačan tok rada",
        "summary": ["Podaci dolaze sa e-faktura", "Bira se više faktura za plaćanje", "Budžet+ kreira SPIRI fajl", "Računovođa učitava fajl i zadržava kontrolu"],
        "sections": [
            ("Više obaveza, jedan fajl", "Izabrane e-fakture se objedine za SPIRI, uz manji rizik greške u iznosu, partneru ili pozivu na broj."),
        ...
        "process": ["Budžet+ preuzme podatke sa dostupnih e-faktura.", "Računovođa označi fakture koje ulaze u plaćanje.", "Program objedini podatke u jedan fajl.", "Računovođa pregleda rezultat i učita fajl u SPIRI."],
        "faq": [
    ...
    },
    {
        ...
        "sections": [
            ...
            ("Jedan dokument, više koristi", "Ista eFaktura služi za knjiženje, pregled obaveza, KUF i SPIRI fajl."),
        ],
        "process_title": "Kako se obrađuje eFaktura",
        "process": ["Učita se eFaktura ili XML dokument.", "Budžet+ prepozna dostupne podatke.", "Računovođa proveri nalog i klasifikaciju.", "Podaci se koriste za knjiženje, preglede i po potrebi SPIRI fajl."],
        "faq": [
    ...
    },
    {
        ...
        "title": "ORIS JSON izvoz za škole | Budžet+",
        "description": "Budžet+ podržava ORIS kontrole i JSON izvoz za škole, uz proveru podataka pre slanja i manje ručnog usklađivanja.",
        "kicker": "ORIS kontrole",
        "h1": "ORIS izvoz sa kontrolom pre predaje",
        "intro": "Budžet+ priprema ORIS JSON izvoz iz podataka koje računovođa već kontroliše.",
        "summary_title": "Manje stresa pred rok",
        "summary": ["ORIS režim po potrebi", "Validacije i označene neusaglašenosti", "JSON izvoz iz pripremljenih podataka", "Pregled pre konačne predaje"],
        "sections": [
            ("Greška treba da se vidi ranije", "ORIS kontrole prate podatke pre završnog izvoza."),
            ("Izvoz iz uređene evidencije", "Budžet+ priprema JSON izvoz iz podataka u sistemu."),
            ("Kontrola ostaje kod računovođe", "Program pomaže da se podaci provere i izvezu. Računovođa pregleda rezultat."),
        ],
        "process_title": "Kako nastaje ORIS izvoz",
        "process": ["Podaci se vode kroz redovno knjiženje i evidencije.", "ORIS kontrole označavaju neusaglašenosti.", "Računovođa ispravlja ili potvrđuje podatke.", "Budžet+ priprema JSON izvoz."],
        "faq": [
            ("Da li je ORIS režim obavezan?", "Ne mora biti uključen za svaki način rada; koristi se kada školi treba taj nivo kontrole i izvoza."),
            ("Da li se izvoz radi iz posebne evidencije?", "Cilj je da izvoz nastaje iz uređenih podataka u sistemu."),
        ],
    ...
    },
    {
        ...
        "intro": "Budžet+ priprema Obrazac 5 iz proknjiženih podataka. Računovođa pregleda rezultat i preuzima fajl za ISPFI.",
        "summary_title": "Manje koraka do izveštaja",
        "summary": ["Nema ponovnog unosa istih podataka", "Brza priprema Obrasca 5", "Pregled pre preuzimanja", "Fajl spreman za ISPFI"],
        "sections": [
            ...
            ("Pregled pre preuzimanja", "Računovođa proverava podatke pre preuzimanja fajla."),
        ],
        "process_title": "Kako nastaje Obrazac 5",
        "process": ["Budžet+ koristi podatke iz završenih knjiženja.", "Program formira Obrazac 5 iz postojećih podataka.", "Računovođa pregleda rezultat.", "Računovođa preuzima fajl spreman za učitavanje u ISPFI."],
        "faq": [
            ("Da li se podaci ponovo kucaju?", "Ne. Izveštaj se priprema iz podataka koji su već u sistemu."),
            ("Da li računovođa može da pregleda rezultat?", "Da. Pregled pre preuzimanja je deo kontrolisanog toka."),
        ],
