...
PAGES = [
    ...
    ("knjizenje-e-faktura-za-skole", "eFakture za automatsko knjiženje | Budžet+", "Proknjižite do 30 e-faktura jednim klikom. Budžet+ preuzima podatke iz SEF-a, povezuje partnere i automatski knjiži odabrane fakture.", "SEF i e-fakture", "eFakture za automatsko knjiženje", "Do 30 e-faktura proknjižite jednim klikom. Budžet+ preuzima podatke, povezuje ili kreira partnere i knjiži odabrane fakture. Vi pregledate rezultat.", ["Preuzimanje podataka sa e-faktura iz SEF-a", "Prepoznavanje i kreiranje partnera", "Do 30 e-faktura jednim klikom", "Zatvaranje avansa uz konačnu fakturu"], ["program-za-racunovodstvo-skola", "spiri-kumulativno-placanje", "spiri-izvodi-skole"]),
    ("spiri-izvodi-skole", "SPIRI izvodi za automatsko knjiženje | Budžet+", "Automatsko knjiženje SPIRI izvoda i isplata avansa u Budžet+ programu, bez ručnog prepisivanja stavki.", "SPIRI izvodi", "SPIRI izvodi za automatsko knjiženje", "Učitajte izvod i pokrenite knjiženje — Budžet+ automatski knjiži njegove stavke, uključujući isplate avansa. Vi pregledate rezultat.", ["Učitavanje SPIRI izvoda", "Knjiženje isplata avansa iz izvoda", "Povezivanje sa partnerima i evidencijom", "Pregled rezultata bez dodatnog potvrđivanja"], ["program-za-racunovodstvo-skola", "izvrsenje-budzeta-skola", "knjizenje-e-faktura-za-skole"]),
    ("iskra-obracuni-knjizenje", "ISKRA obračuni za automatsko knjiženje | Budžet+", "Plate i bolovanja iz ISKRA fajla: automatsko knjiženje stavki obračuna i pripadajućih stavki izvoda. Ostali podržani obračuni zatvaraju se knjiženjem izvoda.", "Plate i bolovanja iz ISKRA sistema", "ISKRA obračuni za automatsko knjiženje", "Plate i bolovanja — kompletno knjiženje iz jednog fajla. Budžet+ iz ISKRA fajla automatski knjiži i stavke obračuna i pripadajuće stavke izvoda. Ostali podržani obračuni zatvaraju se knjiženjem izvoda.", ["Kompletno knjiženje plata i bolovanja iz jednog fajla", "Stavke obračuna i pripadajuće stavke izvoda", "Ostali podržani obračuni: zatvaranje knjiženjem izvoda", "Pregled rezultata bez prepisivanja obračuna"], ["program-za-racunovodstvo-skola", "spiri-izvodi-skole", "zatvaranje-poslovne-godine"]),
