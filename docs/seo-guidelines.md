...
- Zvanični naziv proizvoda: **Budžet+**.
...
1. Program za računovodstvo osnovnih i srednjih škola.
2. SPIRI kumulativno plaćanje.
3. Obrazac 5 i izvoz za ISPFI.
...
- `WebPage` i `BreadcrumbList` JSON-LD za tematske stranice.
- Vidljiva putanja do početne stranice.
- Najmanje dva kontekstualna interna linka.
...
Objavljivati praktične vodiče tek kada postoji stručna provera i originalan primer:

- Kako napraviti fajl za SPIRI kumulativno plaćanje.
- Kako pripremiti Obrazac 5 za ISPFI.
- Najčešće greške pri knjiženju e-faktura u školama.
...
## Zadaci koji zahtevaju pristup vlasnika

1. Verifikovati domain property `budzetplus.rs` u Google Search Console.
2. Poslati `https://budzetplus.rs/sitemap.xml` u Search Console i Bing Webmaster Tools.
...
- Nebrendirani organski klikovi i impresije.
- Upiti za SPIRI, Obrazac 5, računovodstvo škola, e-fakture i ISKRA.
- Broj indeksiranih ciljnih stranica.
- CTR po landing stranici.
- Zakazane prezentacije iz organske pretrage.
- Konverzija organske posete u zahtev za prezentaciju.

Promene title-a, opisa i glavnog sadržaja beležiti uz datum kako bi rezultati mogli da se porede.
